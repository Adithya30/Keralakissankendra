    ...
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-zinc-600">Enter your delivery address before payment.</p>
        ...
        <aside className="h-fit rounded-2xl border border-zinc-200 bg-zinc-50 p-6 shadow-sm">
          ...
          <ul className="mt-4 space-y-2 text-sm text-zinc-600">
            ...
            <li>Order appears in your orders page</li>
          </ul>
          <button
            type="button"
            onClick={checkout}
